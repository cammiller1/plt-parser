...
let translate (globals, functions) =
  ...
  and string_t   = L.pointer_type   (L.i8_type context)   (* pointer type to char *) (* added *)
  in
  ...
  let global_vars : L.llvalue StringMap.t =
    ...
    let global_var m (t, n, se) = 
      let init = match se with
        ...
        (* | _ -> expr se *) (* changed from original complyed codegen: commented out *)
        (* STOPPED ADDING *)
  ...
  let function_decls : (L.llvalue * sfunc_decl) StringMap.t =
    let function_decl m fdecl =
      ...
      and formal_types = 
	Array.of_list (List.map (fun (t,_, e) -> ltype_of_typ t) fdecl.sformals) (* changed *)
  ...
  let build_function_body fdecl =
    ...
    let local_vars =
      let add_formal m (t, n, se) p = (* changed *)
	...
	StringMap.add n local m 
      ...
      and add_local m (t, n, se) = (* changed *)
      (* L.set_value_name n (expr se); (* added *) *) (* changed from original complyed codegen: commented out *)
  ...
  (* STARTED ADDING *)
    ...
    (* use local_var_types to check for valid data types *)
  ...
  (* FINISHED ADDING *)
    ...
    let rec expr builder ((_, e) : sexpr) = match e with
      ...
      | SLits s -> L.build_global_stringptr s "str" builder (* added *)
    ...
    | A.Div     -> L.build_sdiv
	  ...
	  (match op with
      (* Changed: I commented out some entires lines, and portions of other lines *)
